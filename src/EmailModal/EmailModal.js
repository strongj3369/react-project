...
const EmailModal = () => {
    ...
    return (
        <section className={`email-modal ${newState.modalOpen ?
            'email-modal--visible' : ''}`}>
            ...
            <div className="email-modal__container">
                <form className="email-modal__info" onSubmit={newState.submittedForm}>
                    ...
                    <p className="email-modal__message">Join our amazing community of more than <span className="email-modal__highlight-text">300,000 woman</span>
                        who love fashion and receive <span className="email-modal__highlight-text">notifications, discounts, and our award winning newsletter.</span></p>
                    <div className={`email-modal__error-message ${newState.showEmailError ?
